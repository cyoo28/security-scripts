...
def getRoleInfo(iam, awsPrincipal, role, myAccount, orgAccounts, extRoles, intRoles, delRoles):
    ...
    if awsPrincipal.split(":")[4] not in orgAccounts:
        ...
        delRoles[roleName] = {"Creation Date":createDate,"Last Used":lastUseDate}
...
def main(iam, sts, org):
    ...
    delRoles = {} # for roles with trust to an entity that no longer exists
    ...
    for page in iamIterator:
        ...
        for role in page["Roles"]:
            ...
            for statement in role["AssumeRolePolicyDocument"]["Statement"]:
                ...
                if role["RoleName"] in extRoles or role["RoleName"] in intRoles or role["RoleName"] in delRoles:
                    break
                else:
                    ...
                    if "AWS" in principals:
                        ...
                        for awsPrincipal in awsPrincipals:
                            getRoleInfo(iam, awsPrincipal, role, myAccount, orgAccounts, extRoles, intRoles, delRoles)
    ...
    with open(fileName, "a") as file:
        ...
        if delRoles:
            for key, value in intRoles.items():
                file.write("{},{},{},{}\n".format("Deleted", key, value["Creation Date"], value["Last Used"]))
